...
REM Downloads required files: KoboldCPP (No-AVX) and A Model of your choice
...
if exist "server.exe" (
    ...
    echo       This may take a few minutes (~435 MB^)
...
if exist "qwen2.5-3b-instruct-q4_k_m.gguf" (
    ...
    echo [2/2] Downloading Qwen 2.5 3B Model...
    echo       This may take a few minutes (~2.2 GB^)
